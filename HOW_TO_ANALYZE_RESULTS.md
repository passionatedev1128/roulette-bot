...
- **70-90%**: ⚠️ Good - May need minor calibration
...
- **0.5-0.7**: ⚠️ Fair - May have errors
...
💡 RECOMMENDATIONS
   ⚠️  Average confidence is low. Consider:
...
- ⚠️ May need minor calibration
- ⚠️ Generally reliable
- ⚠️ Some false negatives possible

### Fair (70-80% detection, 0.6+ confidence)
- ⚠️ Needs improvement
- ⚠️ Significant errors likely
