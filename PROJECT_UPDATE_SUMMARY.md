...
- [x] Strategy registered in bot factory
- [x] Configuration updated with even_odd strategy
- [x] Betting coordinates configured
- [x] Betting controller supports even/odd
- [x] Win/loss determination for even/odd
- [x] Keepalive system integrated
- [x] StopWin/StopLoss supports count-based
- [x] Cycle management working
- [x] Zero handling implemented
