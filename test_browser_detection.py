...
def test_browser_detection(
    ...
    if screen_region:
        ...
        print("   ⚠️  WARNING: screen_region is null - will capture full screen")
    
    if len(detector.winning_templates) == 0:
        print("\n   ⚠️  WARNING: No winning templates loaded!")
    ...
    if detection_rate >= 90:
        ...
        print("  ⚠️  GOOD but could be better (70-90%)")
        print("  ⚠️  Check saved images to verify ROI is correct")
        print("  ⚠️  Consider adjusting template threshold")
        print("  ⚠️  Test more to ensure consistency")
    elif detection_rate >= 50:
        print("  ⚠️  POOR detection rate (50-70%)")
        print("  ⚠️  Check screen_region coordinates")
        print("  ⚠️  Verify templates match browser")
        print("  ⚠️  Check browser zoom is 100%")
        print("  ⚠️  Verify browser window position")
    else:
