...
⚠️ **No screen automation** - Can't test betting automation (pyautogui)  
⚠️ **Video only** - Can only test detection, not live betting  
⚠️ **File upload size** - Large videos may take time to upload
