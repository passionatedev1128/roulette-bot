...
# ⚠️ IMPORTANT: Mock pyautogui for Colab (headless environment)
...
# ⚠️ IMPORTANT: Make sure pyautogui is mocked (should be done in Step 5)
...
# ⚠️ IMPORTANT: Mock pyautogui first (if not done in Step 5)
from unittest.mock import MagicMock
import sys
        ...
        if verbose:
            ...
            if bet_decision:
                ...
                if action == "entry":
                    ...
                    print(f"  ⚠️  LOSS → Gale step {bet_decision.get('gale_step')}")
