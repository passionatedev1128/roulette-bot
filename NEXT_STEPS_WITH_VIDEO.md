...
- [x] Captured Red (Vermelho) betting button coordinates
- [x] Captured Black (Preto) betting button coordinates
- [x] Verified coordinates are correct
- [x] Using video file for testing (not live game)
...
- ⚠️ Accuracy < 80% (needs improvement)
...
**⚠️ Important:** Betting automation CANNOT be tested with video file!
...
- [x] Number detection accuracy
- [x] Color detection
- [x] Strategy logic (simulation)
- [x] Full detection pipeline
