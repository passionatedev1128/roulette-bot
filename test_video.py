...
def test_video_detection(video_path: str, config_path: str = 'config/default_config.json', 
                        output_dir: str = 'test_results', frame_skip: int = 1):
    """
    ...
    while True:
        ...
        # Display frame (optional - comment out if you don't want window)
        try:
